...
- **[r-cmd-check-cpu-time](./r-lib/r-cmd-check-cpu-time/)** - Diagnose and fix the R CMD check NOTE "had CPU time N times elapsed time", covering how to make the `[cpu/elapsed]` ratio visible, localize the offending test file or vignette on a Linux runner with a threaded BLAS, and cap threads in BLAS, data.table, xgboost, lightgbm, and ranger
